    ...
    , ui(new Ui::Parallelogram)
{
    ...
    connect(resetAction, &QAction::triggered, this, [=]() {
        ...
        ui->resultlabel->setText("Площадь параллелограмма = 0"); // Вернуть метке исходный текст
    });

    QPixmap pix("/Users/antondmitriev/Desktop/Sibsutis/3 course/vp/1lab/figure/assets/parallelogram.png");
...
void Parallelogram::on_calculatePushButton_clicked()
{
    ...
    if (ok1 && ok2 && ok3 && (number3 < 180) && (number1 > 0) && (number2 > 0) && (number3 > 0)) {
        Calculation calc; // Создаем объект класса Calculation
        float result = calc.calculationParallelogram(number1, number2, number3);
        QString resultText = "Площадь параллелограмма = " + QString::number(result);
